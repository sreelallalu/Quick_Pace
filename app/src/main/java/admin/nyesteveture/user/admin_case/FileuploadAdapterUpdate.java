...
public class FileuploadAdapterUpdate extends RecyclerView.Adapter<RecyclerView.ViewHolder>
{  private List<DepartmentList> contactlist;
    Context activity;
    public FileuploadAdapterUpdate(List<DepartmentList>contactlist,Context activity){
    ...
    class ViewHolder1 extends RecyclerView.ViewHolder {
        ...
        public ViewHolder1(View itemView) {
            ...
            vb=(LinearLayout)itemView.findViewById(R.id.rtyuio);
        }  }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        {
            ((ViewHolder1) holder).delete.setVisibility(View.INVISIBLE);
            ...
            ((ViewHolder1) holder).vb.setOnClickListener(new View.OnClickListener() {
                @Override
