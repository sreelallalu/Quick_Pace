 ...
 */
public class RedFragment extends android.support.v4.app.Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        swipeView = (SwipeRefreshLayout) v.findViewById(R.id.swiperrrnm);
    ...
    private void RED_(final View v)
    {
                ...
                try {
                    ...
                    if(succ==1)
                    {
                       ...
                       // RecyclerView   recyclerView=(RecyclerView)vfindViewById(R.id.recyclerview);
                        FileuploadAdapterUpdate1      mAdapter = new FileuploadAdapterUpdate1(list, getActivity());
    ...
    public void showsnackbar(String message,View v){
        ...
        Snackbar snackbar = Snackbar
                .make(v.findViewById(R.id.voool), message, Snackbar.LENGTH_SHORT);
