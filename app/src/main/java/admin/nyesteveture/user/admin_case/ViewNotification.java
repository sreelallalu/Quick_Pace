 ...
 */
public class ViewNotification extends android.support.v4.app.Fragment {
    ...
    private void View_Notification(View v) {
        ...
        hashmap.put("tag","view_notification");
                ...
                try {
                    ...
                    if(succ==1)
                    {
                        ...
                        for(int i=0;i<frt.length();i++)
                        {
                            ...
                            String head_name=op.getString("username");
                            String phone=op.getString("User ID");
                            String satus=op.getString("Messege");
                            String appoved=op.getString("notification_id");
                        ...
                        View_Nofication_Adapter     mAdapter = new View_Nofication_Adapter(list, getActivity());
